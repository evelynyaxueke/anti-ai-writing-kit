# Anti-AI Writing Patterns and Examples

This reference preserves the expanded explanations, pattern lists, and examples behind the compact runtime rules in `SKILL.md`. It is not the runtime controller.

Read the relevant section when a rule is ambiguous, when reviewing or adding a rule, during guided customization, or when an edge case needs examples.

## Contents

1. Operating standard and anti-overfitting
2. Hard bans and positive defaults
